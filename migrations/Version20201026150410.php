 ...
 */
final class Version20201026150410 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produits (id INT AUTO_INCREMENT NOT NULL, taux_tva_id_id INT DEFAULT NULL, categories_id INT DEFAULT NULL, ugs VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, est_publie TINYINT(1) NOT NULL, mis_en_avant TINYINT(1) NOT NULL, visibilite_catalogue TINYINT(1) NOT NULL, description_courte VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_debut_promo DATE DEFAULT NULL, date_fin_promo DATE DEFAULT NULL, etat_tva TINYINT(1) NOT NULL, quantite_stock INT NOT NULL, limite_basse_stock INT NOT NULL, commande_sans_stock TINYINT(1) NOT NULL, vente_individuelle TINYINT(1) NOT NULL, est_evaluable TINYINT(1) NOT NULL, tarif DOUBLE PRECISION NOT NULL, tarif_promo DOUBLE PRECISION DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, delai_telechargement INT DEFAULT NULL, nombre_telechargements INT DEFAULT NULL, INDEX IDX_BE2DDF8CEF054022 (taux_tva_id_id), INDEX IDX_BE2DDF8CA21214B7 (categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(45) NOT NULL, ville VARCHAR(45) NOT NULL, telephone VARCHAR(45) NOT NULL, email VARCHAR(45) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', date_creation DATETIME NOT NULL, date_modification DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
